...
//para apagar mensagens da tela quando clicar no nome do software
...
function mostrarMensagens(usuario, mensagem) {
    ...
    usuario = document.createTextNode(usuario); //é o que?
    mensagem = document.createTextNode(mensagem); //é o que?
